...
function _manually_load_plugin() {
	...
	// @TODO There should be a way to autoload these files, but it wasn't working for the GitHub Action.
	require_once PROJECT_DIR . '/includes/api.php';
	require_once PROJECT_DIR . '/includes/scripts.php';
    require_once PROJECT_DIR . '/yums-order-lookup.php';
}
